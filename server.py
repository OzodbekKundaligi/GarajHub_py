    ...
    try:
        ...
        def handle_start(message):
            ...
            bot.reply_to(message, 
                "👋 *Assalomu alaykum!*\n\n"
                "🚀 *GarajHub* botiga xush kelibsiz!\n\n"
                "Bizning platformada startaplaringizni yarating, boshqa startaplarga qo'shiling "
                "va hamkorlar toping.\n\n"
                "📊 *Foydali buyruqlar:*\n"
                "• /start - Botni ishga tushirish\n"
                "• /help - Yordam\n"
                "• /mystartups - Mening startaplarim\n"
                "• /createstartup - Yangi startup yaratish\n\n"
        ...
        def handle_help(message):
            bot.reply_to(message,
                ...
                "• /mystartups - Mening startaplarim\n"
                "• /createstartup - Yangi startup yaratish\n"
                "• /join - Startapga qo'shilish\n"
                "• /profile - Profilni ko'rish\n\n"
                "📞 *Aloqa:*\n"
                "• Admin: @GarajHub_admin\n"
                "• Kanal: @GarajHub_uz", 
                parse_mode='Markdown')
        ...
        def handle_stats(message):
            if message.from_user.id == ADMIN_ID:
                ...
                bot.reply_to(message,
                    ...
                    f"🚀 Startaplar: *{startups}*\n"
                    f"✅ Faol startaplar: *{active}*\n\n"
                    f"🌐 Admin panel: http://localhost:{PORT}", 
                    parse_mode='Markdown')
